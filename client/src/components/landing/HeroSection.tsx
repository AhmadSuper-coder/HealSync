      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button
            ...
            size="lg"
            className="bg-white text-gray-900 border-2 border-gray-300 hover:bg-gray-50 text-lg px-8 py-6 rounded-full shadow-lg transition-all duration-300 hover:shadow-xl"
          ...
          <Button
            variant="outline"
            size="lg"
            className="text-lg px-8 py-6 rounded-full border-2 transition-all duration-300 hover:bg-blue-50 dark:hover:bg-blue-950"
